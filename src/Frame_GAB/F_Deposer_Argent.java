...
public class F_Deposer_Argent{
	private JFrame frame;
	private JTextField txtDeposer;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					F_Deposer_Argent window = new F_Deposer_Argent();
	...
	public void initialize(int id) {
		...
		JLabel lblNewLabel_1_1_1_1 = new JLabel("Argent d\u00E9poser :");
		lblNewLabel_1_1_1_1.setForeground(new Color(102, 102, 255));
		lblNewLabel_1_1_1_1.setFont(new Font("Cambria Math", Font.PLAIN, 12));
		lblNewLabel_1_1_1_1.setBounds(10, 68, 98, 18);
		panelContent_1.add(lblNewLabel_1_1_1_1);
		
		txtDeposer = new JTextField();
		txtDeposer.setColumns(10);
		txtDeposer.setBounds(108, 67, 126, 20);
		panelContent_1.add(txtDeposer);
		c.acceptNumberInTextField(txtDeposer);
		
		JButton btnValider = new JButton("D\u00E9poser");
		btnValider.setBackground(SystemColor.menu);
		btnValider.setBounds(119, 123, 89, 23);
		panelContent_1.add(btnValider);
		
		JLabel lblAr_1 = new JLabel("Ar");
		lblAr_1.setForeground(new Color(102, 102, 255));
		lblAr_1.setFont(new Font("Cambria Math", Font.PLAIN, 12));
		lblAr_1.setBounds(184, 31, 126, 18);
		panelContent_1.add(lblAr_1);
		
		JLabel lblTitre = new JLabel("D\u00E9p\u00F4t");
		...
		btnValider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int montant = Integer.parseInt(txtDeposer.getText());
				int solde = Integer.parseInt(lblSolde.getText());
				c.deposerArgent(idClient, montant, solde, frame);
			}
		});
